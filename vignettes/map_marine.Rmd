...
The grid is composed of nested squares of `siteSize` meters called site.
...
## Generate the matrix of presence/absence of a sepecimen in sites from the worldmap grid


```{r}
specimenIntersectSites <- specimen_intersect_site(specimen.df=predResBold.verified,
                     grid.sp=grid.sp)
...
```{r}
nucdivSpecies <- species_nucleotide_diversity(specimen.df=predResBold.verified, 
